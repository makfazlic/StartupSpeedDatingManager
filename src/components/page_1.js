              ...
              >
                <div className="min-w-0 flex-1 text-sm leading-6">
                  <label
                    ...
                    className="select-none font-medium text-gray-900 text-xl"
                  >
                    {person.name}
                  </label>
                </div>
